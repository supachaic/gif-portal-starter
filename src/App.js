...
const App = () => {
  ...
  const sendMeme = async () => {
    ...
    try {
      ...
      console.log("MEME sucesfully sent to program", inputValue)
  ...
  const renderConnectedContainer = () => {
    ...
    if (memeList === null) {
      ...
      return (<div className="connected-container">
        <input 
          type="text" 
          placeholder="Enter cat meme link!"
          value={inputValue}
          onChange={onInputChange}
        />
        <button className="cta-button submit-gif-button" onClick={sendMeme}>Submit</button>
        <div className="gif-grid">
          {memeList.map((item, index) => (
            <div className="gif-item" key={index}>
              <img src={item.memeLink} alt="Cat Meme link"/>
            </div>
          ))}
        </div>
      </div>)
    ...
    <div className="App">
      <div className={walletAddress ? 'authed-container' : 'container'}>
        <div className="header-container">
          <p className="header">🐈 Cat Memes Portal</p>
          <p className="sub-text">
            View your cat memes collection in the metaverse ✨
          </p>
